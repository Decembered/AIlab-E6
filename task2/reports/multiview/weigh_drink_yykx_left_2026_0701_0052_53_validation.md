...
- 文件：`task2/outputs/by_sequence/weigh_drink_yykx_left_2026_0701_0052_53/trajectories/hand_traj_multiview.npz`
- T：182
- fps：15.000
- valid_ratio：100.00%
- errors：0
...
- `hand_bbox2d`: shape=(182, 3, 4), dtype=float32
...
- `handedness_by_view`: shape=(182, 3), dtype=<U16
- `handedness_score`: shape=(182,), dtype=float32
- `handedness_score_by_view`: shape=(182, 3), dtype=float32
...
- `multi_view_keypoints2d`: shape=(182, 3, 21, 2), dtype=float32
- `multi_view_keypoints2d_score`: shape=(182, 3, 21), dtype=float32
...
- `reprojection_error`: shape=(182, 3, 21), dtype=float32
- `reprojection_error_frame_median`: shape=(182,), dtype=float32
...
- `triangulation_support`: shape=(182, 21), dtype=int16
- `units`: shape=(), dtype=<U5
- `valid`: shape=(182,), dtype=bool
- `view_valid`: shape=(182, 3), dtype=bool
